...
const addCat=async (params, res) => {
  try {
    //console.log('addCat():', cat)
    const sql='INSERT INTO wop_cat (name, birthdate, weight, owner, filename, coords) VALUES (?, ?, ?, ?, ?, ?)';
    const values=[params[0], params[1], parseFloat(params[2]), parseInt(params[3]), params[4], String(params[5])];
